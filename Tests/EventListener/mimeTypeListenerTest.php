...
use Mbright\Bundle\RepresentBundle\EventListener\MimeTypeListener;
...
class mimeTypeListenerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $formatNegotiator = $this->getMockBuilder('Mbright\Bundle\RepresentBundle\Negotiator\FormatNegotiator')
